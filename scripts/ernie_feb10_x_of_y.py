...
for creds in accounts.values():
    offset=0
    while True:
        params={'minDate':start_date,'maxDate':end_date,'limit':limit,'offset':offset,'cancelled':'false'}
...
print('Ernie Wednesday update 2026-02-10:')
if not today:
    print('No Ernie lessons scheduled yet for that date')
else:
    for appt in today:
...
print('\nTravel base: 35619 N 34th Ave, Phoenix AZ 85086. Say "update traffic" for live routing if needed.')
